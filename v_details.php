...
<div class="sidebar">
    ...
    <div class="main-content">
        ...
        <div class="buttons">
            <a href="c_details.php"class="btn">Committee</a>
            <a href="p_details.php"class="btn">President</a>
            <a href="s_details.php " class="btn">Secretory</a>
            <a href="v_details.php" class="btn">Vice-Secretory</a>
        </div>
        <table>
            <tr>
                <th>Flat Number</th>
    ...
    <a href="adminpage.php">
        <button class="prev-button">change Committee</button>
    </a>
</body>
</html>
